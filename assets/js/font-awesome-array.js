...
(function appendField(){
  ...
  $("#font-awesome-icons").append('<div class="col-lg-3 col-md-3 col-sm-4 col-xs-6"> <i class="fa ' + key + '' + ($(this).is(':selected') ? 'selected' : '') + '">' + '' + value + '</i> </div>');
  });

  $("#font-awesome-icons").append('</select></div>');
})(jQuery);
